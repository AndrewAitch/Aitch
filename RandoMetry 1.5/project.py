...
while(follow == True):
    ...
    os.system('cls')
    verif = ''
    while verif != 'oui' or verif != 'non':
        verif = input('Voulez vous garder la programmation precedente ? (oui/non) ')
        os.system('cls')
    if verif == 'non':
        datas = []
#Reprendre image 
